...
module Hammer
  class ApplicationTemplate < BaseTemplate
    ...
    NO_ERROR_MESSAGE = '<div class="message"><p><b>There are no errors in your project</b></p></div>'
  ...
  private
    ...
    def body
      ...
      # return error_template("No project!") if !@project # No project to build!
      ...
      template = ERB.new File.new(File.join(File.dirname(__FILE__), "application/application.html.erb")).read, nil, "%"
    ...
    # def error_template(error_object=nil)
    #   "
    #     <div class='build-error'>
    #       <span>Error while building!</span>
    #       <span>Error details:</span>
    #       <p>#{error_object}</p>
    #       <p>#{error_object && error_object.backtrace rescue ""}</p>
    #     </div>
    #   "
    # end
    ...
    #   return error_template() if !@project
    #   return error_template(@project.error) if @project.error
